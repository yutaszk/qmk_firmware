...
LSFT_T(KC_MHEN), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                                KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_HENK),
        KC_LALT, _______, _______, _______, KC_RBRC,          MO(SYMB),         MO(SYMB),          KC_LBRC, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,
                                     LSFT_T(KC_SPC), KC_LGUI, MO(SYMB),         MO(SYMB), MO(SYMB),LSFT_T(KC_SPC)
    ),
    ...
    [SYMB] = LAYOUT_moonlander(
        ...
        _______, _______, _______, _______, KC_RPRN,          _______,           _______,          KC_LPRN, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT,
